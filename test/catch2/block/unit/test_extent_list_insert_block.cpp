 ...
 *
 * Test extent list insert/remove functions with block: __wt_extlist_merge_int,
...
TEST_CASE("Extent Lists: block_merge", "[extent_list]")
{
    ...
    SECTION("insert/merge multiple extents and verify all extents after each insert/merge")
    {
        ...
        /* Setup. */
        WT_EXTLIST extlist = {};
        extlist.name = const_cast<char *>("__wt_extlist_merge_int");

        WT_BLOCK block = {};
        block.name = "__wt_extlist_merge_int";
