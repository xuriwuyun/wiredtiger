...
extern WT_EXT *__wt_extlist_off_srch_inclusive(WT_EXTLIST *el, wt_off_t off)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern WT_EXT *__wt_extlist_off_srch_last(WT_EXT **head, WT_EXT ***stack)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern bool __wt_config_get_choice(const char **choices, WT_CONFIG_ITEM *item)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern bool __wt_extlist_first_srch(WT_EXT **head, wt_off_t size, WT_EXT ***stack)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern bool __wt_extlist_off_match(WT_EXTLIST *el, wt_off_t off, wt_off_t size)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_extlist_dump(WT_SESSION_IMPL *session, WT_BLOCK *block, WT_EXTLIST *el,
...
extern int __wt_extlist_ext_insert(WT_SESSION_IMPL *session, WT_EXTLIST *el, WT_EXT *ext)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_extlist_merge(WT_SESSION_IMPL *session, bool verify, WT_EXTLIST *el, wt_off_t off,
  wt_off_t size) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_extlist_off_insert(WT_SESSION_IMPL *session, WT_EXTLIST *el, wt_off_t off,
  wt_off_t size) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_extlist_off_remove(WT_SESSION_IMPL *session, bool verify, WT_EXTLIST *el,
  wt_off_t off, WT_EXT **extp) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_extlist_off_remove_overlap(WT_SESSION_IMPL *session, bool verify, WT_EXTLIST *el,
  wt_off_t off, wt_off_t size) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_extlist_overlap_check(WT_SESSION_IMPL *session, WT_EXTLIST *al, WT_EXTLIST *bl)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wti_extlist_insert_ext(WT_SESSION_IMPL *session, WT_BLOCK *block, WT_EXTLIST *el,
  wt_off_t off, wt_off_t size) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wti_extlist_merge(WT_SESSION_IMPL *session, bool verify, WT_EXTLIST *a, WT_EXTLIST *b)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wti_extlist_off_remove_overlap(WT_SESSION_IMPL *session, bool verify, WT_EXTLIST *el,
  wt_off_t off, wt_off_t size) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
static WT_INLINE double __wt_read_shared_double(double *to_read)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static WT_INLINE int __wt_block_extlist_read_pair(const uint8_t **p, wt_off_t *offp,
  wt_off_t *sizep) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static WT_INLINE int __wt_block_extlist_write_pair(uint8_t **p, wt_off_t off, wt_off_t size)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
